...
class InfoBox extends React.Component{
    ...
    render(){
        ...
        var addText6 = "I want to be 100% transparent - There may come a point where I have to use a small portion of the donations to help pay for the site hosting if traffic on the site picks up. But for the time being, I will be paying for the hosting fees myself while the cost is reasonable.";
